...
tools/swift-test --filter 'CountdownView|PomodoroRenderingTests|CountdownNotificationViewTests|CountdownAccessibilityTests|CountdownWindowStateTests'
```
...
- `Tests/Core/`: timing, configuration, persistence, notification schedules, and geometry.
...
fade completion, centered entrance and exit scaling, space for outward scaling,
Reduce Motion, zero-duration transitions, and cancellation.
